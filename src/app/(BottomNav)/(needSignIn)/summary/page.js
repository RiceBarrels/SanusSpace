...
export default function SummaryPage(){
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                if (data) {
                    const selectedDateConsumed = calculateSelectedDateConsumedCalories(data, selectedDate);
                ...
                if (isNativeIos) {
                    ...
                    if (data) {
                        const weekly = processWeeklyData(data, stepsResult, caloriesResult, sleepResult, selectedDate);
    ...
    }, [user, getUserData, isNativeIos, selectedDate]);
    ...
    const foodCount = getSelectedDateFoodCount(userData, selectedDate);

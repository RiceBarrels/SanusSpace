...
export function SignInCheck(){
    ...
    useEffect(()=>{
        console.log('[SignInCheck] User/authLoading changed:', { user: !!user, authLoading, pathname });
        ...
        if (!authLoading && !user && !isSensitivePage) {
            ...
            console.log('[SignInCheck] User found, loading user data');
            loadUserData();
        }
